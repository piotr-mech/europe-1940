...
| 3 | Persistence & determinism invariants | Save/resume survives schema evolution; determinism becomes a enforced invariant, not an accident | #4, #5 | unit + integration + static rule | change opened | testing-persistence-determinism |
